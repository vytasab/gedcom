  ...
  */
  val msgs: Map[String, Map[String, String]] = Map(
    "03ENGA" -> Map( /* ENGAGEMENT */
      "en" -> "An event of recording or announcing an agreement between two people to become married",
      "lt" -> "Tapo partneriais"),
    "05MARR" -> Map( /* MARRIAGE */
      "en" -> ("A legal, common-law, or customary event of creating a family unit of a man " +
        "and a woman as husband and wife"),
      "lt" -> "Vestuvės"),
      //"lt" -> "Vestuvės (Sukūrė šeimą)"),
    "10DIV" -> Map( /* DIVORCE */
      "en" -> "An event of dissolving a marriage through civil action",
      "lt" -> "Skyrybos"),
    "15MARB" -> Map( /* MARRIAGE_BANN */
      "en" -> "An event of an official public notice given that two people intend to marry",
      "lt" -> "Sužieduotuvės"),
    "20ANUL" -> Map( /* ANNULMENT */
      "en" -> "Declaring a marriage void from the beginning (never existed)",
      "lt" -> "Sužiedotuvės anuliuotos"),
    "25DIVF" -> Map( /* DIVORCE_FILED} */
      "en" -> "An event of filing for a divorce by a spouse",
      "lt" -> "Skirybų pareiškimas"),
    "30MARC" -> Map( /* MARR_CONTRACT */
      "en" -> ("An event of recording a formal agreement of marriage, including the prenuptial " +
    ...
    "40MARL" -> Map( /* MARR_LICENSE */
      "en" -> "An event of obtaining a legal license to marry",
      "lt" -> "Leidimas tuoktis (?)",
