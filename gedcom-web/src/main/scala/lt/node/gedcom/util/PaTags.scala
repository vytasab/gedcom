  ...
  */
  val msgs: Map[String, Map[String, String]] = Map(
    "05DSCR" -> Map( /* PHYSICAL_DESCRIPTION */
      "en" -> "The physical characteristics of a person, place, or thing",
      "lt" -> "Fizinis apibūdinimas"),
    "10EDUC" -> Map( /* EDUCATION, SCHOLASTIC_ACHIEVEMENT  */
      "en" -> "Indicator of a level of education attained.",
      "lt" -> "Išsilavinimas"),
    "15NATI" -> Map( /* NATIONALITY, NATIONAL_OR_TRIBAL_ORIGIN */
      "en" -> "The national heritage of an individual ",
      "lt" -> "Tautybė"),
    "20NCHI" -> Map( /* CHILDREN_COUNT, COUNT_OF_CHILDREN */
      "en" -> ("The number of children that this person is known to be the parent " +
    ...
    "25NMR" -> Map( /* MARRIAGE_COUNT, COUNT_OF_MARRIAGES */
      "en" -> "The number of times this person has participated in a family as a spouse or parent",
      "lt" -> "Santuokų skaičius"),
    "30OCCU" -> Map( /* OCCUPATION */
      "en" -> "The type of work or profession of an individual",
      "lt" -> "Profesija, darbinė veikla"),
    "35PROP" -> Map( /* PROPERTY, POSSESSIONS */
      "en" -> "Pertaining to possessions such as real estate or other property of interest",
      "lt" -> "Nuosavybė - žemė, namai, ..."),
    "40RELI" -> Map( /* RELIGION, RELIGIOUS_AFFILIATION */
      "en" -> "A religious denomination to which a person is affiliated or for which a record applies",
      "lt" -> "Išpažįstama religija"),
    "45RESI" -> Map( /* RESIDENCE */
      "en" -> "The act of dwelling at an address for a period of time",
      "lt" -> "Gyvenamoji vieta"),
    "50TITL" -> Map( /* TITLE, NOBILITY_TYPE_TITLE */
      "en" -> ("A description of a specific writing or other work, such as the title " +
    ...
    "en" -> "A number assigned to identify a person within some significant external system",
