...
// TODO aet up tag sequence
    ...
    "03CHR" -> Map( /* CHRISTENING */
      "en" -> "The religious event (not LDS) of baptizing and/or naming a child.",
      "lt" -> "Krikštijo"),
    ...
    "04GRAD" -> Map( /* GRADUATION */
      "en" -> "An event of awarding educational diplomas or degrees to individuals",
      "lt" -> "Įgijo mokslą"),
    "05IMMI" -> Map( /* IMMIGRATION */
      "en" -> "An event of entering into a new locality with the intent of residing there",
      "lt" -> "Imigravo"),
    "06EMIG" -> Map( /* EMIGRATION */
      "en" -> "An event of leaving one's homeland with the intent of residing elsewhere",
      "lt" -> "Emigravo"),
    "07NATU" -> Map( /* NATURALIZATION */
      "en" -> "The event of obtaining citizenship",
      "lt" -> "Gavo pilietybę"),
    //"CENS" -> Map( /* CENSUS */
    ...
    "08WILL" -> Map( /* WILL */
      "en" -> "A legal document treated as an event, by which a person disposes of his or her estate, to take effect after death. The event date is the date the will was signed while the person was alive. (See also PROBate.)",
      "lt" -> "Patvirtinto testamentą"),
    "09RETI" -> Map( /* RETIREMENT  */
      "en" -> "An event of exiting an occupational relationship with an employer after a qualifying time period",
      "lt" -> "Išėjo pensijon"),
    "10EVEN" -> Map( /* EVENT */
      "en" -> "A noteworthy happening related to an individual, a group, or an organization",
      "lt" -> "Įvykis"),
    "11DEAT" -> Map( /* DEATH */
      "en" -> "The event when mortal life terminates",
      "lt" -> "Mirė"),
    "12BURI" -> Map( /* BURIAL */
      "en" -> "The event of the proper disposing of the mortal remains of a deceased person",
      "lt" -> "Palaidojo"),
    "13CREM" -> Map( /* CREMATION */
      "en" -> "Disposal of the remains of a person's body by fire",
      "lt" -> "Kremavo")
    //,"xxx" -> Map("en" -> "en", "lt" -> "lt")
  )
}
